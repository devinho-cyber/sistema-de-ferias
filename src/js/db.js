        ...
        : "bg-green-100 text-green-800"
            ...
            <div class="grid lg:grid-cols-3 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="number" max="30" min="0" id="dias${vacation.id}" value="${vacation.dias}" class="w-full p-2 border border-gray-200 bg-gray-100 rounded-md" ${isDisabled ? 'disabled' : ''}>
                </div>
                <div>
